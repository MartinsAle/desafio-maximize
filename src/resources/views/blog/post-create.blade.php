    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <form method="POST" action="{{ route('publishPost') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="descricao" class="form-control" id="descricao" placeholder="Descrição do post">
                    </div>
                    <div class="mb-3">
                        <label for="texto-completo" class="form-label">Texto</label>
                        <textarea name="texto_completo" class="form-control" id="texto-completo" cols="30" rows="5" placeholder="Texto do post"></textarea>
                    </div>
                    <div class="mb-3">
